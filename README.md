...
- [提供できること](#提供できること)
- [得意な事](#得意な事)
- [あまり得意じゃない事](#あまり得意じゃない事)
- [エンジニアリングで意識している事](#エンジニアリングで意識している事)
  - [フロントエンドエンジニアとして意識している事](#フロントエンドエンジニアとして意識している事)
  - [バックエンドエンジニアとして意識している事](#バックエンドエンジニアとして意識している事)
  - [クラウドエンジニアとして意識している事](#クラウドエンジニアとして意識している事)
- [スキルセット](#スキルセット)
  - [今メインで使っている技術](#今メインで使っている技術)
  - [過去に経験した技術](#過去に経験した技術)
- [今興味がある技術](#今興味がある技術)
  ...
  - [Vercel](#vercel)
  - [Turso](#turso)
  - [音声・ビデオ会話が出来るリアルタイムAI](#音声ビデオ会話が出来るリアルタイムai)
- [主な職務経歴](#主な職務経歴)
  - [看護師さん向けのメディアサービスの認証基盤のリプレイスを実施（2026年-6月〜現在）](#看護師さん向けのメディアサービスの認証基盤のリプレイスを実施2026年-6月現在)
  - [旅行を支援するプロダクトを提供する自社サービス企業 旅行支援アプリの超大型アップデートを実施（2026年-4月〜2026年6月）](#旅行を支援するプロダクトを提供する自社サービス企業-旅行支援アプリの超大型アップデートを実施2026年-4月2026年6月)
  - [大手人材系会社さんの一部開発チームの開発体制をAI前提の物にアップデート（2026年-1月〜2026年4月）](#大手人材系会社さんの一部開発チームの開発体制をai前提の物にアップデート2026年-1月2026年4月)
  - [旅行を支援するプロダクトを提供する自社サービス企業 開発体制をAI前提の物にアップデート（2025年-6月〜2025年12月）](#旅行を支援するプロダクトを提供する自社サービス企業-開発体制をai前提の物にアップデート2025年-6月2025年12月)
  - [旅行を支援するプロダクトを提供する自社サービス企業でのMCPサーバーおよびAIを利用した旅程生成機能の新基盤開発（2025年-6月〜2025年9月）](#旅行を支援するプロダクトを提供する自社サービス企業でのmcpサーバーおよびaiを利用した旅程生成機能の新基盤開発2025年-6月2025年9月)
  - [株式会社Algomatic 音声チャットサービス にじチャットの開発（2025年-1月〜2025年3月）](#株式会社algomatic-音声チャットサービス-にじチャットの開発2025年-1月2025年3月)
  - [株式会社Algomatic 音声合成サービス にじボイスの開発（2024年-10月〜2024年12月）](#株式会社algomatic-音声合成サービス-にじボイスの開発2024年-10月2024年12月)
  - [LLMで動画ファイルの翻訳を行うアプリケーションの開発（2024年-6月〜2024年9月）](#llmで動画ファイルの翻訳を行うアプリケーションの開発2024年-6月2024年9月)
  - [AI開発を専門に行う会社のオウンドメディアとAIエージェントの作成（2024年-3月〜2024年5月）](#ai開発を専門に行う会社のオウンドメディアとaiエージェントの作成2024年-3月2024年5月)
  - [クレジットカード会社のサポート用チャットボットの新規開発（2024年-1月〜2024年2月）](#クレジットカード会社のサポート用チャットボットの新規開発2024年-1月2024年2月)
  - [LLMを利用した就職支援サービスの新規開発（2023年-7月〜2023年12月）](#llmを利用した就職支援サービスの新規開発2023年-7月2023年12月)
  - [大規模サービスの認証・認可基盤のリプレイス（2022年-8月〜2023年3月）](#大規模サービスの認証認可基盤のリプレイス2022年-8月2023年3月)
  - [医療系メディアアプリケーションのフロントエンドを Next.js を利用した形にリプレイス（2021〜2022）](#医療系メディアアプリケーションのフロントエンドを-nextjs-を利用した形にリプレイス20212022)
  - [メール送信を行う為のAPIの開発（2021）](#メール送信を行う為のapiの開発2021)
  - [郵便番号から住所検索を行う事が出来るAPIの開発（2021）](#郵便番号から住所検索を行う事が出来るapiの開発2021)
  - [クラウドファンディングサービスのメッセージ一斉送信機能の改善（2021）](#クラウドファンディングサービスのメッセージ一斉送信機能の改善2021)
  - [クラウドファンディングサービスの認証基盤構築（2020〜2021）](#クラウドファンディングサービスの認証基盤構築20202021)
  - [クラウドファンディングサービスの応援コメントを取得する機能をAPI化（2020）](#クラウドファンディングサービスの応援コメントを取得する機能をapi化2020)
  - [ユーザーに通知を送るAPIをKubernetes（EKS）上で開発（2020）](#ユーザーに通知を送るapiをkuberneteseks上で開発2020)
  - [AWSを用いたアプリケーションインフラ基盤の構築（2019）](#awsを用いたアプリケーションインフラ基盤の構築2019)
  - [EC2のアプリケーションをAWS Fargateに移行（2018）](#ec2のアプリケーションをaws-fargateに移行2018)
  - [看護師向けのコミュニティサイトの全面リプレイス（2017）](#看護師向けのコミュニティサイトの全面リプレイス2017)
  - [某大手ECサイト 会員基盤の全面リプレイス（2016）](#某大手ecサイト-会員基盤の全面リプレイス2016)
  - [社内用認可基盤の開発（2015）](#社内用認可基盤の開発2015)
  - [社内用共通デプロイツールの改修（2014年）](#社内用共通デプロイツールの改修2014年)
  - [某大手ECサイト ソーシャルログイン機能を導入（2013年）](#某大手ecサイト-ソーシャルログイン機能を導入2013年)
  - [某大手ECサイト ユーザーの個人情報を取得するAPIを高速化（2013年）](#某大手ecサイト-ユーザーの個人情報を取得するapiを高速化2013年)
  - [某大手ECサイト ユーザーの個人情報を取得するAPIを開発（2013年）](#某大手ecサイト-ユーザーの個人情報を取得するapiを開発2013年)
...
- AIが設計方針に迷わないように、ドメイン駆動設計等で分かりやすいアーキテクチャとして採用されるオニオンアーキテクチャを採用（もちろんAI向けのルールも整備しました）
...
にじチャットはにじボイスのキャラクターと音声で会話が出来るサービスです。
