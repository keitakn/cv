...
最近、インフラ側のコードをAWS Lambdaで書く事が多いのでTypeScript OR Goを書く機会が一番多いかもしれません。
...
| Next.js |       B      | 新規開発のアプリケーションで複数回利用しました。                                                           |
...
## Next.js
個人的にはVue.jsとよりもReactのほうが、TypeScriptの型システムの恩恵を受けやすい点（この点はVue.js3.0系でかなり改善されそうですが）やベストプラクティスを公式が積極的に情報発信している点なので、気に入っているのですが、Vue.jsベースのNuxt.jsのほうが機能が豊富でフレームワークとしての完成度は高いと思っていました。
